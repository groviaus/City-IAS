...
import { BookOpen, ArrowLeft, Plus, X, Save, Eye, Loader2 } from "lucide-react";
    ...
    try {
      ...
      if (response.ok) {
        ...
        setCourseData({
          ...
          registration: course.registration?.toString() || "",
          badge: course.badge || "",
          badgeColor: course.badge_color || "bg-green-500",
          borderColor: course.border_color || "border-green-200",
          iconBg: course.icon_bg || "bg-green-100",
          iconColor: course.icon_color || "text-green-600",
          titleColor: course.title_color || "text-green-700",
          buttonText: course.button_text || "",
          buttonColor: course.button_color || "bg-green-600 hover:bg-green-700",
